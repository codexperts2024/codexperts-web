                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12"> 
                        <div className="lg:cols-span-2">
                            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 font-montserrat">
                                Spring Coding 
                                <br/>
                                Competition 2026
                            </h1>
                            ...
                            <div className="flex flex-wrap items-center gap-8 mt-8 text-sm text-gray-500">
                                ...
                                <div className="flex items-center gap-2">
                                    <svg className="w-5 h-5 text-gray-500 ml-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
