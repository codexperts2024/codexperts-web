     ...
     <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-6">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-7 flex flex-col sm:flex-row items-center justify-between gap-4 mt-14">
              ...
              <button className="bg-red-700 hover:bg-red-800 text-white font-semibold px-6 py-3 rounded-md transition font-inter text-sm">
                Register Now
              </button>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mt-10 pt-20 border-t border-gray-100">
            <button className="border border-gray-300 hover:bg-gray-100 text-gray-800 px-5 py-2.5 rounded-md flex items-center gap-2 transition font-inter text-sm">
