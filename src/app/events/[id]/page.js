...
export default async function EventPage({ params }) {
  ...
  // Get adjacent events for navigation
  const { previous, next } = getAdjacentEvents(event.id);
  ...
  return (
    <div className="min-h-screen w-full bg-[#F9F9F9]">
      ...
      {/* Hero Banner - Changes color based on status */}
      ...
      {/* ============================================
          PAST EVENT LAYOUT - WITH GRID (preserved exactly)
      ============================================ */}
      {isPast && (
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-16 lg:py-20">
          ...
          {/* About Section - WITH GRID (preserved exactly as you had it) */}
          <div className="mt-12">
